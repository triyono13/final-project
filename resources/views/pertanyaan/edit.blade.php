            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @if(count ($errors)>0)
                        ...
                        @endforeach
                    @endif
                    <form class="form-horizontal" action="{{route('pertanyaan.update', $pertanyaan->id)}}" method="POST" enctype='multipart/form-data'>
                    @csrf
                    @method('PATCH')
                        <div class="form-group row">
                            <label class="col-lg-2 col-form-label" for="simpleinput"> - Judul Pertanyaan</label>
                                <div class="col-lg-7">
                                    <input type="text" class="form-control" name="judul" value="{{$pertanyaan->judul}}" placeholder="Masukkan Nama Perusahaan Loker">
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12">
                                <textarea class="form-control" name="isi" id="profile">{{$pertanyaan->isi_pertanyaan}}</textarea>
                            </div>
                        </div><hr>
                        <div class="form-group row">
